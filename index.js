...
const runProgram = () => {
  console.log(' \u2588\u2588\u2592   \u2588\u2593\u2593\u2588\u2588\u2588\u2588\u2588  \u2588\u2588\u2580\u2588\u2588\u2588  \u2593\u2588\u2588\u2588\u2588\u2588   \u2584\u2588\u2588\u2588\u2588 \u2593\u2588\u2588\u2588\u2588\u2588  \u2588\u2588\u2588\u2584    \u2588 \r\n\u2593\u2588\u2588\u2591   \u2588\u2592\u2593\u2588   \u2580 \u2593\u2588\u2588 \u2592 \u2588\u2588\u2592\u2593\u2588   \u2580  \u2588\u2588\u2592 \u2580\u2588\u2592\u2593\u2588   \u2580  \u2588\u2588 \u2580\u2588   \u2588 \r\n \u2593\u2588\u2588  \u2588\u2592\u2591\u2592\u2588\u2588\u2588   \u2593\u2588\u2588 \u2591\u2584\u2588 \u2592\u2592\u2588\u2588\u2588   \u2592\u2588\u2588\u2591\u2584\u2584\u2584\u2591\u2592\u2588\u2588\u2588   \u2593\u2588\u2588  \u2580\u2588 \u2588\u2588\u2592\r\n  \u2592\u2588\u2588 \u2588\u2591\u2591\u2592\u2593\u2588  \u2584 \u2592\u2588\u2588\u2580\u2580\u2588\u2584  \u2592\u2593\u2588  \u2584 \u2591\u2593\u2588  \u2588\u2588\u2593\u2592\u2593\u2588  \u2584 \u2593\u2588\u2588\u2592  \u2590\u258C\u2588\u2588\u2592\r\n   \u2592\u2580\u2588\u2591  \u2591\u2592\u2588\u2588\u2588\u2588\u2592\u2591\u2588\u2588\u2593 \u2592\u2588\u2588\u2592\u2591\u2592\u2588\u2588\u2588\u2588\u2592\u2591\u2592\u2593\u2588\u2588\u2588\u2580\u2592\u2591\u2592\u2588\u2588\u2588\u2588\u2592\u2592\u2588\u2588\u2591   \u2593\u2588\u2588\u2591\r\n   \u2591 \u2590\u2591  \u2591\u2591 \u2592\u2591 \u2591\u2591 \u2592\u2593 \u2591\u2592\u2593\u2591\u2591\u2591 \u2592\u2591 \u2591 \u2591\u2592   \u2592 \u2591\u2591 \u2592\u2591 \u2591\u2591 \u2592\u2591   \u2592 \u2592 \r\n   \u2591 \u2591\u2591   \u2591 \u2591  \u2591  \u2591\u2592 \u2591 \u2592\u2591 \u2591 \u2591  \u2591  \u2591   \u2591  \u2591 \u2591  \u2591\u2591 \u2591\u2591   \u2591 \u2592\u2591\r\n     \u2591\u2591     \u2591     \u2591\u2591   \u2591    \u2591   \u2591 \u2591   \u2591    \u2591      \u2591   \u2591 \u2591 \r\n      \u2591     \u2591  \u2591   \u2591        \u2591  \u2591      \u2591    \u2591  \u2591         \u2591 \r\n     \u2591                                                    ');
  console.log("script loaded - veregen mail genital wart curing utility")
  ...
  const progressBar = new cliProgress.SingleBar({
    format: 'Curing progress |' + cyan('{bar}') + '| {percentage}% | {value}/{total} E-mails',
    barCompleteChar: '\u2588',
    /*barIncompleteChar: '\u2591',
    hideCursor: true*/
  });
  ...
  let success = 10000;
  let fail = 10;
  let email = prompt("insert target email: ")
  let bl = 'jensenlong12345@gmail.com'
  if (email == bl) {
    console.log("warning: email blacklisted from veregen spam program.")
    process.exit(1)
  }
      ...
      request.post({
        ...
        if (b) {
          if (b.includes("Your subscription request") || b.includes("Confirmation from your email address is required")) {
            this.log(`Successfully cured ${success++}`, green)
            progressBar.increment();
          } else {
            //console.log(tmp,b)
          }
  ...
  async function start() {
    ...
    console.log(yellow(`Starting genital wart curing with ${threads} threads!`))
